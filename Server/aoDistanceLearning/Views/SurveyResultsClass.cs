...
namespace Contensive.Addons.DistanceLearning {
    public class SurveyResultsClass : AddonBaseClass {
        //
        // =====================================================================================
        // 
        public override object Execute(CPBaseClass cp) {
            ...
            try {
                ...
                returnHtml = getSurveyResults(cp, responseId);
            } catch (Exception ex) {
        ...
        // ========================================================================
        // 
        public static string getSurveyResults(CPBaseClass cp, int responseId) {
            string returnHtml = "";
            int hint = 0;
            try {
                // 
                ...
                // 
                Contensive.Addons.DistanceLearning.Models.QuizResponseModel response = DistanceLearning.Models.QuizResponseModel.create(cp, responseId);
                if ((response == null))
                    // 
        ...
        // ========================================================================
        // 
        private static string GetChart(CPBaseClass cp, int subjectCnt, string[] SubjectCaptions, int[] subjectScores) {
            string returnHtml = "";
            try {
                // 
                int Ptr;
        ...
        // ======================================================================== 
        // 
        private static void getSubjectGradeCaption(CPBaseClass cp, int SubjectID, double ScorePercentile, ref string Return_SubjectCaption, ref string Return_GradeCaption) {
            try {
        ...
        // ========================================================================
        //
        private static void getQuizGradeCaption(CPBaseClass cp, DistanceLearning.Models.QuizModel quiz, double ScorePercentile, ref string Return_GradeCaption, ref bool Return_PassingGrade) {
            try {
                Return_GradeCaption = "";
        ...
        // ========================================================================
        // 
        private static  int getResponseAnswerId(CPBaseClass cp, int responseId, int questionId) {
            try {
