...
namespace Contensive.Addons.DistanceLearning {
    namespace Models {
        public class QuizModel : DesignBlockBaseModel {
            ...
            /// table definition
            /// </summary>
            public static  DbBaseTableMetadataModel tableMetadata { get; } = new DbBaseTableMetadataModel("Quizzes", "quizzes", "default", false);
            //
            ...
            public FieldTypeHTMLFile studyCopy { get; set; }
            ...
            public static QuizModel createOrAddSettings(CPBaseClass cp, string requestQuizGuid) {
                ...
                question2.name = "Question " + question2.id.ToString();
