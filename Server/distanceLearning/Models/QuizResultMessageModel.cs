...
namespace Contensive.Addons.DistanceLearning.Models
{
    ...
    class QuizResultMessageModel
    {
        //
        //-- const
        public const string primaryContentName = "Quiz Result Messages";
        private const string primaryContentTableName = "quizResultMessages";
        //
        // -- instance properties
        public int id;
        public string name;
        ...
        public static QuizResultMessageModel create(CPBaseClass cp, int recordId)
        {
        ...
        public static QuizResultMessageModel create(CPBaseClass cp, string recordGuid)
        {
            QuizResultMessageModel result = null;
            try
            {
        ...
        private static QuizResultMessageModel loadObject(CPBaseClass cpCore, string sqlCriteria)
        {
            QuizResultMessageModel result = null;
            try
            {
        ...
        /// <returns></returns>
        public static List<QuizResultMessageModel> getObjectList(CPBaseClass cp, int someCriteria)
        {
            List<QuizResultMessageModel> result = new List<QuizResultMessageModel>();
            try
            {
                CPCSBaseClass cs = cp.CSNew();
                ...
                {
                    QuizResultMessageModel instance = null;
                    do
                    {
                        instance = QuizResultMessageModel.create(cp, cs.GetInteger("id"));
                        if ((instance != null))
                        {
                            result.Add(instance);
                        }
