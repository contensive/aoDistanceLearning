...
Namespace Contensive.Addons.OnlineQuiz
    ...
    Module constants
        ...
        Public Const defaultButtonCopy = "<p>Click continue to move to the next page, and submit when you are finished with the quiz.</p>"
        Public Const defaultButtonWithSaveCopy = "<p>Click continue to move to the next page, and submit when you are finished with the quiz. If you are logged in, you may also save the quiz and return later.</p>"
