...
'                End If
'            Catch ex As Exception
'                Call cp.Site.ErrorReport(ex, "getScoreCard-hint=" & hint.ToString())
'            End Try
'            Return returnHtml
'        End Function
'        '
...
'            Catch ex As Exception
'                Call cp.Site.ErrorReport(ex, "verifyQuizResponse")
'            End Try
'            Return returnHtml
'        End Function
'        '
...
'                Call cs.Close()
'            Catch ex As Exception
'                Call cp.Site.ErrorReport(ex, "getSubjectGradeCaption")
'            End Try
'        End Sub
'        '
...
'                End If
'            Catch ex As Exception
'                Call cp.Site.ErrorReport(ex, "getQuizGradeCaption")
'            End Try
'        End Sub
'        '
'        '
